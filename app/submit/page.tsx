...
export default function SubmitChallengePage() {
  ...
  const urgencyLevels = [
    {
      value: "urgent",
      label: "URGENT - Immediate operational need",
      color: "bg-red-600",
    },
    {
      value: "high",
      label: "HIGH - Critical capability gap",
      color: "bg-orange-600",
    },
    {
      value: "medium",
      label: "MEDIUM - Important enhancement",
      color: "bg-yellow-600",
    },
    {
      value: "low",
  ...
  const trlLevels = [
    ...
    },
    {
      ...
      description:
        "Active R&D is initiated with analytical and laboratory studies",
    },
    {
      value: "5-6",
      ...
      <div className="container mx-auto px-4 py-8 max-w-4xl">
        ...
        <Alert className="mb-6 border-yellow-600 bg-yellow-600/10">
          ...
          <AlertDescription className="text-yellow-200">
            <strong>OPSEC Reminder:</strong> Do not include classified
            information, specific unit designations, operational details, or
            sensitive location data. All submissions are subject to moderation
            review.
          </AlertDescription>
        </Alert>
        ...
        <Card className="mb-6 bg-slate-800 border-slate-700">
          <CardHeader>
            ...
            <CardDescription className="text-slate-400">
              Your submission will go through the following review process
            </CardDescription>
          </CardHeader>
          <CardContent>
              ...
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <h4 className="text-white font-medium">
                    Initial OPSEC Review
                  </h4>
                  <p className="text-sm text-slate-400">
                    Automated check for sensitive information
                  </p>
                </div>
              </div>
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <h4 className="text-white font-medium">Moderator Review</h4>
                  <p className="text-sm text-slate-400">
                    Manual review by verified DoD moderators
                  </p>
                </div>
              </div>
              <div className="flex items-center space-x-3">
        ...
        <form onSubmit={handleSubmit} className="space-y-8">
          ...
          <Card className="bg-slate-800 border-slate-700">
            <CardHeader>
              ...
              <CardDescription className="text-slate-400">
                Provide a clear and concise description of your tactical
                challenge.
              </CardDescription>
            </CardHeader>
                  ...
                  >
                    ...
                    <SelectContent>
                      {domains.map((domain) => (
                        <SelectItem
                          key={domain}
                          value={domain.toLowerCase().replace(/\s+/g, "-")}
                        >
                          {domain}
                        </SelectItem>
                      ))}
            ...
            <CardContent className="space-y-6">
              <div>
                ...
                <Select
                  ...
                  onValueChange={(value) =>
                    setFormData((prev) => ({ ...prev, trlLevel: value }))
                  }
                >
                  <SelectTrigger className="mt-2 bg-slate-700 border-slate-600">
          ...
          <Card className="bg-slate-800 border-slate-700">
            <CardHeader>
              ...
              <CardDescription className="text-slate-400">
                Upload a video overview to provide additional context
                (optional).
              </CardDescription>
            </CardHeader>
            <CardContent>
                ...
                <label htmlFor="video-upload" className="cursor-pointer">
                  ...
                  <p className="text-slate-300 mb-2">
                    {formData.videoFile
                      ...
                      : "Click to upload video overview"}
                  </p>
                  <p className="text-xs text-slate-500">
                    MP4, MOV, AVI up to 100MB. Keep under 5 minutes for best
                    engagement.
                  </p>
                </label>
              </div>
              ...
              {showOpsecWarning && (
                <Alert className="border-red-600 bg-red-600/10">
                  ...
                  <AlertDescription className="text-red-200">
                    <strong>Warning:</strong> Challenges involving classified
                    information require additional review and may be restricted
                    to verified users only. Ensure all details comply with
                    security protocols before submission.
                  </AlertDescription>
                </Alert>
              )}
            </CardContent>
